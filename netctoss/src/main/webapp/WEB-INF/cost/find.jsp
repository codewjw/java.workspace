<!--使用版本XHTML 1.0，则meta使用 http-equiv="Content-Type"设置-->
                    ...
                    <table id="datalist">
                        ...
                        <c:forEach items="${costs}" var="cost">
                           <tr>
                            ...
                            <td>${cost.unitCose} 元/小时</td>
                            <td>
                             <fmt:formatDate value="${cost.creaTime }"></fmt:formatDate>
                            </td>
                            <td><fmt:formatDate value="${cost.startime }"></fmt:formatDate></td>
                            <td>
                            ...
                            <td>                                
                                ...
                                <!-- onclick="location.href='toupdateCost.do?id=${cost.costId}';" EL表达式是在
                                                                                 服务器端执行的程序，所以也可这个么写：
                                 onclick="location.href='toupdateCost.do?id='"+${cost.costId} -->
