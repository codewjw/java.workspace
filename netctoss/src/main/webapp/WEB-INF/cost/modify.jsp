    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updateCost.do" method="post" class="main_form">
                ...
                <input type="text" class="readonly" name="costId" readonly value="${cost.costId }" />
                </div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" name="costName" class="width300" value="${cost.name }"/>
                ...
                <div class="input_info fee_type">
                    <c:if test="${cost.costType=='1' }">
                      <input type="radio" name="costType" checked value="1" id="monthly" onclick="feeTypeChange(1);" />
                      ...
                      <label for="monthly">包月</label>
                      <input type="radio" name="costType" checked value="2" id="package" onclick="feeTypeChange(2);" />
                      <label for="package">套餐</label>
                      <input type="radio" name="costType" value="3" id="timeBased" onclick="feeTypeChange(3);" />
                      <label for="timeBased">计时</label>
                      </c:if>
                      ...
                      <input type="radio" name="costType" value="2" id="package" onclick="feeTypeChange(2);" />
                      <label for="package">套餐</label>
                      <input type="radio" name="costType" checked value="3" id="timeBased" onclick="feeTypeChange(3);" />
                      <label for="timeBased">计时</label>
                      </c:if>   
                </div>
                ...
                <div class="input_info">
                    <input type="text" name="unitCost" value="${cost.unitCose }" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name="desc">${cost.descr }</textarea>
